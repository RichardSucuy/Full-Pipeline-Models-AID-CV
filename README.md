...
## 📌 Project Overview
The core of this research is documented in the [Full Pipeline - Models - AID-CV.ipynb](./Full_Pipeline_-_Models_-_AID-CV.ipynb) notebook, which includes data preprocessing, model selection, training, and comprehensive evaluation.
...
> **Author Name**, *Trypanosoma Cruzi Detection in Microscopic Blood Samples*, (2024), GitHub repository: [Link to your repo]
